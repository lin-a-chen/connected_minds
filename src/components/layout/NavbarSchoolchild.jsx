    ...
    const signOutHandler = async () => {
        ...
        <div className={styles.navbarUnauthedContainer}>
            ...
            <nav className={styles.navbarUnauthed}>
                <ul>
                    <li>
                        <Link href="/cabinet/schoolchild/academic-records">Журнал оцінок</Link>
                    </li>
                    <li>
                        <Link href="/cabinet/schoolchild/schedule">Розклад класів</Link>
                    </li>
                    <li>
                        <Link href="/cabinet/schoolchild"><LuUser/></Link>
                    </li>
                    <li>
...
export default NavbarSchoolchild;
