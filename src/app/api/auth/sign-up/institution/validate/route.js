...
export async function POST(req) {
    ...
    try{
        const userResult = await User.findById(body.institutionAdminUserId);
        ...
        if (body.institutionAdminUserId.length > 0){
        ...
        if (requestResult.data.request_type === 'ADD_INSTITUTION'){
