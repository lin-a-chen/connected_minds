...
<p style="margin: 0;">ConnectedMinds</p>
  ...
  export async function sendResetPasswordMail(email, heading, ifWrongUserMessage, text, token) {
    ...
    <div align="left" class="alignment">
    <!--[if mso]>
    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${url}/auth/reset-password/${token}" style="height:42px;width:174px;v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#f6a988">
    <w:anchorlock/>
    ...
    <![endif]-->
    <!--[if !mso]><!-- -->
    <a href="${url}/auth/reset-password/${token}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#f6a988;border-radius:4px;width:auto;border-top:1px solid #f6a988;font-weight:700;border-right:1px solid #f6a988;border-bottom:1px solid #f6a988;border-left:1px solid #f6a988;padding-top:10px;padding-bottom:10px;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:24px;padding-right:24px;font-size:16px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word; line-height: 32px;">Перейти на сайт</span></span></a>
    <!--<![endif]-->
    </div>
    </td>
    </tr>
